...
int main(){
    ...
    setTextColor(0, 0, 0);
    setTextSize(20);
    drawString(100, 575, "プレイヤー0");
    drawString(100, 625, "プレイヤー1");
    drawString(250, 575, "0 点");
    drawString(250, 625, "0 点");
    setTextSize(12);

    setColor(255, 255, 0);
    fillCircle(85, 585, 10);
    ...
    while(true){
        if(delCardNum == 52){
            setTextSize(72);
            setTextColor(0, 0, 0);
            if(playerScore1 > playerScore2) drawString(540, 260, "player0の勝利");
            if(playerScore1 < playerScore2) drawString(540, 260, "player1の勝利");
            break;
        }
        delCardNum = 0;
        waitForPoint();
        ...
        drawString(100, 575, "プレイヤー0");
        drawString(100, 625, "プレイヤー1");
        drawString(260, 575, " 点");
        drawString(260, 625, " 点");
        drawString(250, 575, to_string(playerScore1));
        drawString(250, 625, to_string(playerScore2));
        setTextSize(12);
